label splashscreen:
    ...
    로잘린드 @입_벌림 "얼굴이 붉어졌군요. 체온도 조금씩 올라가고 있습니다."
    로잘린드 "설마 저 때문에 이렇게 되셨을까요?"
    독백 "너무나도 생생하게 느껴지는 부드러운 감촉에 또 한 번 당황했다."
    로잘린드 눈썹_웃음 입_미소 "후후. 이런 반응을 보여주시면 저도 조금 장난을 쳐보고 싶어집니다."

    ## TODO::
    # 뒷짐 지고 주인공을 올려다 보는 로잘린드 - 특수스탠딩 주문
    # 표정 - 미소, 눈 감고 입술 쭉 내밀기
    독백 "조금 짓궂은 미소를 지은 미녀가 나와 시선을 올곧게 마주쳤다."
    로잘린드 눈썹_보통 입_보통 "무례를 용서하시길"
    주인공 "어… 어어……?"
    show 로잘린드 눈썹_웃음 눈_감음 입_미소
    독백 "그 말과 함께 눈을 감은 미녀."
