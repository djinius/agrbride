...
label splashscreen:
    ...
    로잘린드 몬무스 "왜 그러십니까? 그렇게 빤히 제 얼굴을 보시다니."
    로잘린드 몬무스 "혹시 어딘가 편찮으십니까?"
    독백 "조금 걱정된다는 듯, 무미건조한 표정 속에 밋밋한 변화를 준 한 명의 미녀."
    로잘린드 몬무스 "으음. 머리에 열은 없으신 모양입니다만."
    주인공 "으앗!?"
    독백 "대뜸 나와 이마를 맞대는 미녀. 갑자기 가까워진 거리에 나는 한 번 놀랐고."
    로잘린드 몬무스 "얼굴이 붉어졌군요. 체온도 조금씩 올라가고 있습니다."
    로잘린드 몬무스 "설마 저 때문에 이렇게 되셨을까요?"
    독백 "너무나도 생생하게 느껴지는 부드러운 감촉에 또 한 번 당황했다."
    로잘린드 몬무스 "후후. 이런 반응을 보여주시면 저도 조금 장난을 쳐보고 싶어집니다."
